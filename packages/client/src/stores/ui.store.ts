...
export const DEFAULT_APP_BACKGROUND_DARK = "#141517";
export const DEFAULT_APP_BACKGROUND_LIGHT = "#f8f8f9";
const DEFAULT_APP_BACKGROUNDS = new Set([
  DEFAULT_APP_BACKGROUND_DARK,
  DEFAULT_APP_BACKGROUND_LIGHT,
  "#050312",
  "#faf8ff",
]);
export const DEFAULT_APP_ACCENT_DARK = "#d4acfb";
export const DEFAULT_APP_ACCENT_LIGHT = "#69428d";
